...
//        }
        entries1.add(new PieEntry((float) (29), "Task 1"));
        entries1.add(new PieEntry((float) (47), "Task 2"));
        entries1.add(new PieEntry((float) (8), "Task 3"));
        entries1.add(new PieEntry((float) (15), "Task 4"));

        PieDataSet ds1 = new PieDataSet(entries1, "Atividades da última semana");
